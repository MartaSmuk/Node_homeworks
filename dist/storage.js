...
exports.users = []; // List of users (you can define the User structure with more details)
exports.carts = []; // List of carts, each containing products and a userId
exports.orders = []; // List of orders containing products, userId, total price, and order date
